...
class _$LoginPressedImpl implements LoginPressed {
  const _$LoginPressedImpl(this.email, this.password);
  ...
  @override
  String toString() {
    return 'LoginFormEvent.loginPressed(email: $email, password: $password)';
  }
...
abstract class LoginPressed implements LoginFormEvent {
  const factory LoginPressed(final String email, final String password) =
      _$LoginPressedImpl;
...
abstract class _$$StoreTokenImplCopyWith<$Res> {
  factory _$$StoreTokenImplCopyWith(
          _$StoreTokenImpl value, $Res Function(_$StoreTokenImpl) then) =
...
class __$$StoreTokenImplCopyWithImpl<$Res>
  ...
  __$$StoreTokenImplCopyWithImpl(
      _$StoreTokenImpl _value, $Res Function(_$StoreTokenImpl) _then)
      : super(_value, _then);
